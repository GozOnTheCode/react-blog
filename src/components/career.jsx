...
import '../App.css'
import designerImage from '../img/tunnel.jpg'
    ...
    return( 
        <>
            <div className="designer-div">
                <p className="p-designer">Editorial</p>
                <h1 className="h1-designer">Starting and<br/>Growing a Career in<br/>Web Design in 2022</h1>
            ...
            <div className="designer-para">
                    ...
                    <h1 className="h1-designer-title">What does a career in web design involve?</h1>
                        <p className='para-1'>
